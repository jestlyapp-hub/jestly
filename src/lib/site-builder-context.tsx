...
const defaultContent: { [K in BlockType]: BlockContentMap[K] } = {
  ...
  newsletter: { title: "Newsletter", description: "Restez informé", placeholder: "Votre email", buttonLabel: "S'abonner", successMessage: "Merci ! Vous êtes inscrit.", saveAsLead: true, leadSource: "newsletter" as const },
  ...
  "form-newsletter-lead": { title: "Recevez nos meilleurs conseils", subtitle: "Chaque semaine, des tips actionables sur le branding, le web et la stratégie digitale. Rejoignez +2 000 abonnés.", placeholder: "Votre adresse email", ctaLabel: "S'inscrire gratuitement", privacyNote: "Pas de spam. Désabonnement en un clic.", successMessage: "Merci ! Vous êtes inscrit à notre newsletter.", saveAsLead: true, leadSource: "newsletter" as const },
