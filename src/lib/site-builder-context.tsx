...
const defaultContent: { [K in BlockType]: BlockContentMap[K] } = {
  ...
  "project-before-after": { title: "Transformations", items: [{ beforeLabel: "Ancien site vitrine", afterLabel: "Nouvelle landing premium", resultText: "+250% de leads", description: "Refonte complete avec strategie de conversion et design premium." }, { beforeLabel: "Logo generique", afterLabel: "Identite sur-mesure", resultText: "Reconnaissance x3", description: "Creation d'une identite visuelle forte et memorable." }, { beforeLabel: "Thumbnails basiques", afterLabel: "Thumbnails optimisees", resultText: "+180% de CTR", description: "Optimisation visuelle pour maximiser les clics sur YouTube." }] },
