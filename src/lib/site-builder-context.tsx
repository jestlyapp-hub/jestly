...
const defaultContent: { [K in BlockType]: BlockContentMap[K] } = {
  ...
  "custom-form": { fields: [{ label: "Nom", type: "text", required: true }], submitLabel: "Envoyer", successMessage: "Merci ! Votre message a bien ete envoye.", saveAsLead: true },
  ...
  "project-masonry-wall": { title: "Portfolio", items: [{ title: "Identite Aura", category: "Branding" }, { title: "App FinTrack", category: "UI/UX" }, { title: "Reel NovaTech", category: "Video" }, { title: "Site Bloom", category: "Web" }, { title: "Campagne Zenith", category: "Marketing" }, { title: "Packaging Maison", category: "Print" }], columns: 3, source: "manual" as const },
