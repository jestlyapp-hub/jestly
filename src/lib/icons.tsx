...
export const ICON_REGISTRY: IconDef[] = [
  // --- Video / Media ---
  { key: "video", label: "Video", keywords: ["video", "film", "clip"], svg: <I><polygon points="23 7 16 12 23 17 23 7" /><rect x="1" y="5" width="15" height="14" rx="2" ry="2" /></I> },
  ...
  // --- Tech / Dev ---
  { key: "code", label: "Code", keywords: ["code", "dev", "developpeur", "programmation"], svg: <I><polyline points="16 18 22 12 16 6" /><polyline points="8 6 2 12 8 18" /></I> },
  ...
  { key: "smartphone", label: "Smartphone", keywords: ["smartphone", "mobile", "telephone", "phone"], svg: <I><rect x="5" y="2" width="14" height="20" rx="2" ry="2" /><line x1="12" y1="18" x2="12.01" y2="18" /></I> },
  { key: "monitor", label: "Desktop", keywords: ["desktop", "ecran", "monitor", "ordinateur"], svg: <I><rect x="2" y="3" width="20" height="14" rx="2" ry="2" /><line x1="8" y1="21" x2="16" y2="21" /><line x1="12" y1="17" x2="12" y2="21" /></I> },
  ...
  { key: "settings", label: "Parametres", keywords: ["settings", "parametres", "engrenage", "config"], svg: <I><circle cx="12" cy="12" r="3" /><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1 0 2.83 2 2 0 0 1-2.83 0l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-2 2 2 2 0 0 1-2-2v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83 0 2 2 0 0 1 0-2.83l.06-.06A1.65 1.65 0 0 0 4.68 15a1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1-2-2 2 2 0 0 1 2-2h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 0-2.83 2 2 0 0 1 2.83 0l.06.06A1.65 1.65 0 0 0 9 4.68a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 2-2 2 2 0 0 1 2 2v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 0 2 2 0 0 1 0 2.83l-.06.06A1.65 1.65 0 0 0 19.4 9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 2 2 2 2 0 0 1-2 2h-.09a1.65 1.65 0 0 0-1.51 1z" /></I> },

  // --- Business / Commerce ---
  { key: "zap", label: "Eclair", keywords: ["zap", "eclair", "lightning", "rapide", "energie"], svg: <I><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2" /></I> },
  ...
  { key: "rocket", label: "Fusee", keywords: ["rocket", "fusee", "lancement", "startup"], svg: <I><path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.13-.09-2.91a2.18 2.18 0 0 0-2.91-.09z" /><path d="M12 15l-3-3a22 22 0 0 1 2-3.95A12.88 12.88 0 0 1 22 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 0 1-4 2z" /><path d="M9 12H4s.55-3.03 2-4c1.62-1.08 5 0 5 0" /><path d="M12 15v5s3.03-.55 4-2c1.08-1.62 0-5 0-5" /></I> },
  ...
  { key: "pie-chart", label: "Repartition", keywords: ["pie", "chart", "camembert", "repartition"], svg: <I><path d="M21.21 15.89A10 10 0 1 1 8 2.83" /><path d="M22 12A10 10 0 0 0 12 2v10z" /></I> },
  ...
  { key: "phone", label: "Telephone", keywords: ["phone", "telephone", "appel", "contact"], svg: <I><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" /></I> },
  ...
  { key: "clock", label: "Horloge", keywords: ["clock", "horloge", "temps", "duree", "delai"], svg: <I><circle cx="12" cy="12" r="10" /><polyline points="12 6 12 12 16 14" /></I> },
  ...
  { key: "users", label: "Equipe", keywords: ["users", "equipe", "groupe", "team", "personnes"], svg: <I><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2" /><circle cx="9" cy="7" r="4" /><path d="M23 21v-2a4 4 0 0 0-3-3.87" /><path d="M16 3.13a4 4 0 0 1 0 7.75" /></I> },
  ...
  // --- Misc ---
  { key: "star", label: "Etoile", keywords: ["star", "etoile", "favori", "note", "avis"], svg: <I><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" /></I> },
  ...
  { key: "shield", label: "Bouclier", keywords: ["shield", "bouclier", "securite", "protection", "confiance"], svg: <I><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" /></I> },
  { key: "sparkles", label: "Etincelles", keywords: ["sparkles", "etincelles", "magie", "ia", "ai", "nouveau"], svg: <I><path d="M12 3l1.5 5.5L19 10l-5.5 1.5L12 17l-1.5-5.5L5 10l5.5-1.5L12 3z" /><path d="M19 14l.9 3.1L23 18l-3.1.9L19 22l-.9-3.1L15 18l3.1-.9L19 14z" /></I> },
  ...
  { key: "upload", label: "Upload", keywords: ["upload", "telecharger", "envoyer", "importer"], svg: <I><polyline points="16 16 12 12 8 16" /><line x1="12" y1="12" x2="12" y2="21" /><path d="M20.39 18.39A5 5 0 0 0 18 9h-1.26A8 8 0 1 0 3 16.3" /></I> },
  { key: "download", label: "Download", keywords: ["download", "telecharger", "recevoir", "exporter"], svg: <I><polyline points="8 17 12 21 16 17" /><line x1="12" y1="12" x2="12" y2="21" /><path d="M20.88 18.09A5 5 0 0 0 18 9h-1.26A8 8 0 1 0 3 16.3" /></I> },
  { key: "award", label: "Trophee", keywords: ["award", "trophee", "prix", "medaille", "recompense"], svg: <I><circle cx="12" cy="8" r="7" /><polyline points="8.21 13.89 7 23 12 20 17 23 15.79 13.88" /></I> },
  { key: "eye", label: "Vue", keywords: ["eye", "oeil", "vue", "voir", "visibilite"], svg: <I><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z" /><circle cx="12" cy="12" r="3" /></I> },
  { key: "lock", label: "Verrou", keywords: ["lock", "verrou", "securite", "prive", "mot de passe"], svg: <I><rect x="3" y="11" width="18" height="11" rx="2" ry="2" /><path d="M7 11V7a5 5 0 0 1 10 0v4" /></I> },
  ...
  { key: "headphones", label: "Casque", keywords: ["headphones", "casque", "audio", "ecoute", "musique"], svg: <I><path d="M3 18v-6a9 9 0 0 1 18 0v6" /><path d="M21 19a2 2 0 0 1-2 2h-1a2 2 0 0 1-2-2v-3a2 2 0 0 1 2-2h3zM3 19a2 2 0 0 0 2 2h1a2 2 0 0 0 2-2v-3a2 2 0 0 0-2-2H3z" /></I> },
  { key: "wifi", label: "Connexion", keywords: ["wifi", "connexion", "reseau", "internet", "signal"], svg: <I><path d="M5 12.55a11 11 0 0 1 14.08 0" /><path d="M1.42 9a16 16 0 0 1 21.16 0" /><path d="M8.53 16.11a6 6 0 0 1 6.95 0" /><line x1="12" y1="20" x2="12.01" y2="20" /></I> },
  ...
  { key: "coffee", label: "Cafe", keywords: ["coffee", "cafe", "pause", "detente"], svg: <I><path d="M18 8h1a4 4 0 0 1 0 8h-1" /><path d="M2 8h16v9a4 4 0 0 1-4 4H6a4 4 0 0 1-4-4V8z" /><line x1="6" y1="1" x2="6" y2="4" /><line x1="10" y1="1" x2="10" y2="4" /><line x1="14" y1="1" x2="14" y2="4" /></I> },
];
