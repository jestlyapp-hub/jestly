...
export const blockRegistry: BlockRegistryEntry[] = [
  ...
  { type: "projects-grid-cases", name: "Projets Case Studies", description: "Grille 2x2 de projets avec resultats", category: "portfolio", supportsProjects: true },
  { type: "projects-horizontal", name: "Projets Horizontal", description: "Carrousel horizontal de projets creatifs", category: "portfolio", supportsProjects: true },
  { type: "project-before-after", name: "Projet Avant/Apres", description: "Transformations clients avec resultats", category: "portfolio", supportsProjects: true },
  { type: "project-timeline", name: "Etude de Cas Timeline", description: "Parcours projet etape par etape", category: "portfolio", supportsProjects: true },
  ...
  { type: "services-icon-grid", name: "Services Grille Icones", description: "6 services avec icones en grille", category: "services", supportsProducts: true },
  { type: "services-split-value", name: "Services Valeur Split", description: "Positionnement premium avec piliers", category: "services" },
  { type: "services-process-offers", name: "Services + Process", description: "Offres avec workflow integre", category: "services", supportsProducts: true },
  { type: "product-featured-card", name: "Produit Vedette", description: "Carte produit unique avec benefices", category: "vente", supportsProducts: true },
  ...
  { type: "product-bundle-compare", name: "Comparaison Bundles", description: "3 formules avec features comparees", category: "vente", supportsProducts: true },
  ...
  { type: "pricing-custom-quote", name: "Tarif Sur Devis", description: "Offre premium sur devis personnalise", category: "conversion", supportsProducts: true },
  ...
  { type: "form-quote-request", name: "Demande de Devis", description: "Formulaire devis avance avec projet", category: "contact", capturesLeads: true },
  { type: "form-newsletter-lead", name: "Newsletter / Lead", description: "Capture email newsletter legere", category: "contact", capturesLeads: true },
