...
export default function ProjectsHorizontalBlockEditor({ block }: { block: Extract<Block, { type: "projects-horizontal" }> }) {
  ...
  const addProject = () => {
    update({ projects: [...block.content.projects, { imageUrl: "", title: "Nouveau projet", category: "Design" }] });
  };
  ...
  return (
    <div className="space-y-3">
      ...
      <div>
        <label className="block text-[12px] font-medium text-[#5A5A58] mb-1">Libellé du CTA</label>
