...
export default function FormContactSimpleBlockEditor({ block }: { block: Extract<Block, { type: "form-contact-simple" }> }) {
  ...
  return (
    <div className="space-y-3">
      ...
      <div>
        <label className="block text-[12px] font-medium text-[#5A5A58] mb-1">Note de confiance</label>
        <input type="text" value={block.content.trustNote ?? ""} onChange={(e) => update({ trustNote: e.target.value })} className={inputClass} />
      </div>
