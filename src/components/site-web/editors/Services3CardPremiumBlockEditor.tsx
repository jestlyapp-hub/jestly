...
export default function Services3CardPremiumBlockEditor({
  block,
}: {
  block: Extract<Block, { type: "services-3card-premium" }>;
}) {
  ...
  const addService = () => {
    update({
      services: [
        ...services,
        { title: "", description: "", features: [], ctaLabel: "" },
      ],
    });
  };
        ...
        {services.map((svc, index) => (
          ...
          >
            ...
            <input
              ...
              value={svc.ctaLabel}
              onChange={(e) =>
                updateService(index, "ctaLabel", e.target.value)
              }
