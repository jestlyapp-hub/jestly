...
const inputClass =
  "w-full bg-[#F7F7F5] border border-[#E6E6E4] rounded-md px-3 py-1.5 text-[13px] text-[#1A1A1A] focus:outline-none focus:border-[#4F46E5]/30 focus:ring-1 focus:ring-[#4F46E5]/20 transition-all";
