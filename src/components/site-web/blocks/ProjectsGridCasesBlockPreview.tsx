...
function ProjectsGridCasesBlockPreviewInner({ content }: { content: ProjectsGridCasesBlockContent }) {
  const source = content.source || "manual";

  // Determine cards to render
  const cards: { imageUrl?: string; title: string; category: string; result?: string }[] =
