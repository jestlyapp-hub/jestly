  ...
  },
  {
    ...
    content: (
      <div className="space-y-2.5">
        <div className="font-semibold text-[11px] text-[#1A1A1A]">Pack Logo Complet</div>
      ...
      <div className="space-y-2">
        ...
        {[
          ...
          <div key={r.name} className="flex items-center justify-between">
            <span className="text-[9px] text-[#1A1A1A] font-medium">{r.name}</span>
    ...
    content: (
      <div className="space-y-2.5">
        <div className="flex items-center gap-2">
          ...
          <div>
            <div className="text-[10px] font-semibold text-[#1A1A1A]">Marie Dupont</div>
        ...
        <div className="grid grid-cols-2 gap-2">
          <div className="bg-[#F7F7F5] rounded p-1.5">
            ...
            <div className="text-[11px] font-bold text-[#1A1A1A]">1 240 &euro;</div>
          </div>
          <div className="bg-[#F7F7F5] rounded p-1.5">
            <div className="text-[8px] text-[#999]">Commandes</div>
            <div className="text-[11px] font-bold text-[#1A1A1A]">3</div>
          </div>
        </div>
      </div>
    ),
    ...
    content: (
      <div className="space-y-2.5">
        <div className="flex items-center justify-between">
          <span className="text-[10px] font-semibold text-[#1A1A1A]">FAC-2026-014</span>
        ...
        <div className="border-t border-[#EFEFEF] pt-2 space-y-1">
          <div className="flex justify-between text-[9px]">
            ...
            <span className="text-[#1A1A1A]">350 &euro;</span>
          </div>
          <div className="flex justify-between text-[9px]">
            <span className="text-[#999]">Color grading</span>
            <span className="text-[#1A1A1A]">150 &euro;</span>
          </div>
        </div>
      ...
      <div className="grid grid-cols-3 gap-3 mb-8">
        {previews.map((preview, i) => (
          ...
          >
            ...
            <div className="text-[10px] font-semibold text-[#1A1A1A] mb-2">{preview.title}</div>
            {preview.content}
