...
const competitor = "Notion";

const summaryLeft = [
  "Notes et bases de données flexibles",
  "Collaboration d\u2019équipe",
  "Templates communautaires",
];

const summaryRight = [
  "CRM, facturation et commandes intégrés",
  "Site vitrine et portfolio inclus",
  "Pensé spécifiquement freelance créatif",
];

const tableRows: { critere: string; competitor: string; jestly: string }[] = [
  { critere: "Gestion commandes", competitor: "no", jestly: "yes" },
  { critere: "CRM intégré", competitor: "no", jestly: "yes" },
  { critere: "Facturation", competitor: "no", jestly: "yes" },
  { critere: "Site vitrine", competitor: "no", jestly: "yes" },
  { critere: "Calendrier pro", competitor: "no", jestly: "yes" },
  { critere: "Notes & docs", competitor: "yes", jestly: "yes" },
  { critere: "Analytics business", competitor: "no", jestly: "yes" },
  { critere: "Prise en main", competitor: "Complexe", jestly: "Rapide" },
];
...
const benefits = [
  {
    ...
    description:
      "Contrairement à Notion qui demande de tout construire soi-même, Jestly offre un espace prêt à l\u2019emploi pour gérer commandes, clients et factures.",
  },
  {
    title: "Site vitrine inclus",
    description:
      "Publiez un portfolio professionnel directement depuis Jestly — impossible nativement avec Notion.",
  },
  {
    title: "Zéro configuration",
    description:
      "Pas besoin de créer des bases de données relationnelles ou des formules complexes. Tout est déjà structuré pour un freelance créatif.",
  },
];
...
export default function JestlyVsNotionPage() {
  return (
      ...
      <div className="mx-auto max-w-4xl px-6 py-24 md:py-32">
        ...
        >
          ...
          <p className="text-lg text-[#6B6F80] max-w-2xl mx-auto">
            Notion excelle pour les notes et la documentation collaborative, mais il n&apos;est pas conçu pour piloter l&apos;activité d&apos;un freelance créatif.
          </p>
        </motion.div>
