...
const competitor = "Google Sheets";

const summaryLeft = [
  "Gratuit et accessible",
  "Flexible et partageable",
  "Formules puissantes",
];

const summaryRight = [
  "Interface pensée métier, pas un tableur",
  "Automatisations sans formules",
  "Données structurées et exploitables",
];

const tableRows: { critere: string; competitor: string; jestly: string }[] = [
  { critere: "Suivi commandes", competitor: "Manuel", jestly: "Automatisé" },
  { critere: "CRM", competitor: "Bricolé", jestly: "Structuré" },
  { critere: "Facturation", competitor: "Manuel", jestly: "Automatique" },
  { critere: "Site vitrine", competitor: "no", jestly: "yes" },
  { critere: "Calendrier", competitor: "no", jestly: "yes" },
  { critere: "Fiabilité données", competitor: "Fragile", jestly: "Robuste" },
  { critere: "Temps de gestion", competitor: "Élevé", jestly: "Minimal" },
  { critere: "Rendu pro", competitor: "Non", jestly: "Oui" },
];

const benefits = [
  {
    title: "Un vrai outil, pas un bricolage",
    description:
      "Fini les tableurs qui cassent au moindre copier-coller. Jestly structure vos données dans une interface pensée pour votre métier.",
  },
  {
    title: "Automatisations intégrées",
    description:
      "Plus besoin de formules complexes pour calculer un CA ou suivre des échéances. Tout se met à jour automatiquement.",
  },
  {
    title: "Image professionnelle",
    description:
      "Envoyez des factures propres, affichez un portfolio en ligne et gérez vos clients dans un espace qui inspire confiance.",
  },
];
...
export default function JestlyVsGoogleSheetsPage() {
  return (
      ...
      <div className="mx-auto max-w-4xl px-6 py-24 md:py-32">
        ...
        >
          ...
          <p className="text-lg text-[#6B6F80] max-w-2xl mx-auto">
            Google Sheets est un outil de dépannage, pas une solution métier. Gérer son activité dans un tableur, c&apos;est fragile et chronophage.
          </p>
        </motion.div>
