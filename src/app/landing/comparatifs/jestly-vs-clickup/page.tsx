...
const competitor = "ClickUp";

const summaryLeft = [
  "Très complet en gestion de projet",
  "Nombreuses vues et options",
  "Adapté aux équipes",
];

const summaryRight = [
  "Simple et rapide pour un freelance solo",
  "Facturation et site inclus",
  "Pas besoin de configurer pendant 3 jours",
];

const tableRows: { critere: string; competitor: string; jestly: string }[] = [
  { critere: "Gestion projets", competitor: "yes", jestly: "yes" },
  { critere: "CRM", competitor: "Basique", jestly: "Complet" },
  ...
  { critere: "Courbe d\u2019apprentissage", competitor: "Longue", jestly: "Rapide" },
  { critere: "Analytics", competitor: "yes", jestly: "yes" },
  { critere: "Adapté freelance solo", competitor: "Moyen", jestly: "Oui" },
];
...
const benefits = [
  {
    ...
    description:
      "ClickUp propose des centaines de fonctionnalités. Jestly ne garde que celles qui comptent pour un freelance créatif, sans complexité inutile.",
  },
  {
    title: "Opérationnel en 5 minutes",
    description:
      "Pas de longue phase de configuration. Créez votre compte et commencez à gérer vos commandes, clients et factures immédiatement.",
  },
  {
    title: "Facturation et site inclus",
    description:
      "Deux fonctionnalités essentielles que ClickUp ne propose pas : la facturation intégrée et un site vitrine professionnel.",
  },
];
...
export default function JestlyVsClickUpPage() {
  return (
      ...
      <div className="mx-auto max-w-4xl px-6 py-24 md:py-32">
        ...
        >
          ...
          <p className="text-lg text-[#6B6F80] max-w-2xl mx-auto">
            ClickUp est un outil de gestion de projet puissant, mais sa complexité le rend surdimensionné pour un freelance solo.
          </p>
        </motion.div>
