...
const DATA: PersonaPageData = {
  ...
  features: [
    ...
    { title: "Pipeline", gradient: "projets.", description: "Suivez chaque commande de la demande initiale à la livraison finale. Vision claire en temps réel.", bullets: ["Kanban visuel par statut", "Deadlines et rappels", "Livraison trackée"], icon: "M9 5H2v7l6.29 6.29a1 1 0 001.42 0l5.58-5.58a1 1 0 000-1.42z", color: "#F59E0B" },
