...
export async function GET(_req: NextRequest, ctx: Ctx) {
  ...
  return NextResponse.json({
    project: {
      ...
      portfolioDisplayTitle: data.portfolio_display_title,
      portfolioSubtitle: data.portfolio_subtitle,
      portfolioResult: data.portfolio_result,
      portfolioSummary: data.portfolio_summary,
      portfolioCoverUrl: data.portfolio_cover_url,
      portfolioCoverItemId: data.portfolio_cover_item_id,
      portfolioSlug: data.portfolio_slug,
      portfolioCtaLabel: data.portfolio_cta_label,
      portfolioCtaUrl: data.portfolio_cta_url,
      portfolioFeatured: data.portfolio_featured || false,
      portfolioDisplayOrder: data.portfolio_display_order || 0,
      portfolioVisibility: data.portfolio_visibility || "draft",
      portfolioIntroText: data.portfolio_intro_text,
      portfolioChallengeText: data.portfolio_challenge_text,
      portfolioSolutionText: data.portfolio_solution_text,
      portfolioResultText: data.portfolio_result_text,
      portfolioGalleryItemIds: data.portfolio_gallery_item_ids || [],
      portfolioSeoTitle: data.portfolio_seo_title,
      portfolioSeoDescription: data.portfolio_seo_description,
...
export async function PATCH(req: NextRequest, ctx: Ctx) {
  ...
  const allowed: Record<string, string> = {
    ...
    portfolioDisplayTitle: "portfolio_display_title",
    portfolioSubtitle: "portfolio_subtitle",
    portfolioResult: "portfolio_result",
    portfolioSummary: "portfolio_summary",
    portfolioCoverUrl: "portfolio_cover_url",
    portfolioCoverItemId: "portfolio_cover_item_id",
    portfolioSlug: "portfolio_slug",
    portfolioCtaLabel: "portfolio_cta_label",
    portfolioCtaUrl: "portfolio_cta_url",
    portfolioFeatured: "portfolio_featured",
    portfolioDisplayOrder: "portfolio_display_order",
    portfolioVisibility: "portfolio_visibility",
    portfolioIntroText: "portfolio_intro_text",
    portfolioChallengeText: "portfolio_challenge_text",
    portfolioSolutionText: "portfolio_solution_text",
    portfolioResultText: "portfolio_result_text",
    portfolioGalleryItemIds: "portfolio_gallery_item_ids",
    portfolioSeoTitle: "portfolio_seo_title",
    portfolioSeoDescription: "portfolio_seo_description",
