  ...
  return (
    <div className="max-w-6xl mx-auto">
      ...
      >
        ...
        <button className="flex items-center gap-1.5 bg-[#4F46E5] text-white text-[13px] font-semibold px-4 py-2.5 rounded-lg hover:bg-[#4338CA] transition-colors self-start">
      ...
      <SlidePanel
        ...
        title={selected ? `Commande ${selected.id.slice(0, 8)}` : ""}
      >
        {selected && (
