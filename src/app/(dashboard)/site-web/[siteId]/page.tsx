    ...
    <div className="max-w-6xl mx-auto">
            ...
            <div className="space-y-2">
              ...
              {hasSubdomain ? (
                ...
                >
                  ...
                  <div>
                    <div className="text-[13px] font-medium text-[#1A1A1A]">Configurer le domaine</div>
                    <div className="text-[11px] text-[#999]">Réserver un sous-domaine</div>
                  </div>
                </Link>
              )}
              <Link
                href={`/site-web/${siteId}/parametres`}
                className="flex items-center gap-3 p-3 rounded-lg border border-[#E6E6E4] hover:bg-[#F7F7F5] transition-colors"
              >
                <div className="w-8 h-8 rounded-lg bg-[#EEF2FF] flex items-center justify-center">
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#4F46E5" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      >
        <div className="px-5 py-4 border-b border-[#E6E6E4] flex items-center justify-between">
          ...
          <Link href={`/site-web/${siteId}/commandes`} className="text-[12px] font-medium text-[#4F46E5] hover:underline">
            Tout voir
          </Link>
        </div>
      ...
      >
        ...
        <Link href={`/site-web/${siteId}/analytics`} className="text-[13px] font-medium text-[#4F46E5] hover:underline">
          Voir les analytics
        </Link>
      </motion.div>
    </div>
