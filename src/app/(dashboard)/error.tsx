...
/* ═══════════════════════════════════════════════════════════════════════
   DASHBOARD ERROR BOUNDARY — Erreurs dans l'espace de travail
   ═══════════════════════════════════════════════════════════════════════ */
    ...
    <div className="flex flex-1 items-center justify-center px-6 py-20">
      <div className="max-w-md w-full text-center">
        ...
        <p className="text-[14px] text-[#66697A] mb-8 leading-relaxed">
          Une erreur est survenue dans ton espace de travail. Tu peux
          r&eacute;essayer ou retourner au dashboard.
        </p>
